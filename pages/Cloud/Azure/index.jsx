...
const index = () => {
  return (
    ...
    <Head>
        ...
        <title>
          Empowering Your Cloud Journey: Azure Solutions by Giri InfoTech
        </title>

        <meta
          name="description"
          content="Transform your business with Giri InfoTech's Azure solutions, harnessing the robust capabilities of Microsoft Azure. Our technology unleashes the power of the cloud, providing scalable, secure, and innovative solutions. Explore how Giri InfoTech is driving digital transformation through Azure for enhanced agility, efficiency, and business growth." />
