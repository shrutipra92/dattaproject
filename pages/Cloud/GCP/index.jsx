...
const index = () => {
  return (
    <>
        ...
        <title>
          Unleashing Innovation in the Cloud: GCP Solutions by Giri InfoTech  Technology
        </title>

        <meta
          name="description"
          content="Elevate your business to new heights with Giri InfoTech 's GCP solutions, leveraging the power of Google Cloud Platform. Our technology brings scalable, reliable, and cutting-edge cloud solutions to drive innovation. Explore how Giri InfoTech  is reshaping the digital landscape through GCP for enhanced performance, flexibility, and efficiency." />
