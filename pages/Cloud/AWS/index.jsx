...
const index = () => {
  return (
    <>
        ...
        <title>
          Unleash the Power of the Cloud: AWS Solutions by Giri InfoTech
        </title>

        <meta
          name="description"
          content="Elevate your business to new heights with Brizsolution's AWS solutions. Our technology leverages the robust capabilities of Amazon Web Services, offering scalable and secure cloud solutions. Explore how Giri InfoTech is driving innovation through AWS for enhanced performance, flexibility, and reliability." />
