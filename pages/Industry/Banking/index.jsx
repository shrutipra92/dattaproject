...
const index = () => {
  return (
    <>
        ...
        <title>
          Transforming Banking Experiences with Giri InfoTech  Solutions
        </title>

        <meta
          name="description"
          content="Explore the future of banking with Giri InfoTech's innovative technology solutions. From secure digital banking to personalized financial services, our technology redefines the banking experience. Discover how Giri InfoTech is driving innovation, efficiency, and security in the banking sector." />
