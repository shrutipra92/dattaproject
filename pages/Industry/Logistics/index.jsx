...
const index = () => {
  return (
    <>
        ...
        <title>
          Efficient Logistics Solutions for Seamless Supply Chains | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Optimize your supply chain with Giri InfoTech's cutting-edge logistics solutions. From real-time tracking to intelligent route optimization, our technology enhances every step of the logistics process. Discover how Giri InfoTech is revolutionizing the logistics industry for greater efficiency and reliability." />
