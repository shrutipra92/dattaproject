...
const index = () => {
  return (
    <>
        ...
        <title>
          Empower Independent Vendors with Giri InfoTech  | Vendor Management Solutions
        </title>

        <meta
          name="description"
          content="Giri InfoTech's technology solutions empower independent vendors to thrive in the digital marketplace. From streamlined inventory management to enhanced customer engagement, discover how Giri InfoTech is redefining the landscape for independent vendors. Explore our tailored solutions for a more efficient and profitable vendor experience." />
