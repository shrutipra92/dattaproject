...
const index = () => {
  return (
    <>
        ...
        <title>
          Empowering Energy and Utilities | Innovative Solutions by Giri InfoTech
        </title>

        <meta
          name="description"
          content="Explore the cutting-edge solutions for the energy and utilities sector at Giri InfoTech. Our innovative technologies redefine energy production, enhance utility services, and drive sustainability. Discover how Giri InfoTech is shaping the future of energy for a cleaner and more efficient world." />
