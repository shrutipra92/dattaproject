...
const index = () => {
  return (
    <>
        ...
        <title>
          Smart Insurance Solutions for a Secure Future | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Discover intelligent insurance solutions with Giri InfoTech. Our innovative technology redefines the insurance landscape, providing seamless policy management, enhanced risk assessment, and personalized coverage. Explore how Giri InfoTech is shaping the future of insurance for a more secure and protected tomorrow." />
