...
const index = () => {
  return (
    <>
        ...
        <title>
          Revolutionizing Healthcare Solutions | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Discover the future of healthcare with Giri InfoTech. Our innovative solutions transform patient care, streamline medical processes, and advance healthcare technology. Explore how Giri InfoTech is leading the way in shaping a healthier and more efficient healthcare landscape." />
