...
const index = () => {
  return (
    <>
        ...
        <title>
          Innovative Technology Solutions for a Smarter Tomorrow | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Explore the forefront of technology with Giri InfoTech. Our innovative solutions redefine industries, enhance processes, and drive digital transformation. Discover how Giri InfoTech is leading the way in shaping a connected, efficient, and technologically advanced world." />
