...
const index = () => {
  return (
    <>
        ...
        <title>
          Transforming Agriculture with Innovative Solutions | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Explore the future of agriculture with Giri InfoTech. Our innovative solutions redefine farming practices for sustainability and efficiency. Discover precision farming, smart irrigation, and more. Join us in shaping the future of agriculture for a greener and smarter world." />
