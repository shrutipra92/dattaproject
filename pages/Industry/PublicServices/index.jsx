...
const index = () => {
  return (
    <>
        ...
        <title>
          Innovative Technology for Public Services | Giri InfoTech
        </title>

        <meta
          name="description"
          content="Giri InfoTech's technology solutions empower public services with innovation and efficiency. From streamlined administrative processes to enhanced citizen services, our technology redefines the landscape of public service delivery. Discover how Giri InfoTech is driving positive change in public sectors for a connected and responsive community." />
