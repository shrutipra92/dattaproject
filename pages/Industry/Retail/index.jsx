...
const index = () => {
  return (
    <>
        ...
        <title>
          Elevate Retail Experiences with Giri InfoTech  Solutions
        </title>

        <meta
          name="description"
          content="Discover the future of retail with Giri InfoTech's cutting-edge technology solutions. From seamless e-commerce platforms to in-store innovations, our technology transforms the retail landscape. Explore how Giri InfoTech is enhancing customer experiences, optimizing operations, and reshaping the retail industry." />
