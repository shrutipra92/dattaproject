...
const index = () => {
  return (
    <>
        ...
        <title>
          Elevate Your Shopping Experience | Giri InfoTech  E-commerce Solutions
        </title>

        <meta
          name="description"
          content="Explore a seamless online shopping experience with Giri InfoTech's innovative e-commerce solutions. From user-friendly interfaces to secure payment gateways, our technology enhances every step of the e-commerce journey. Discover how Giri InfoTech is revolutionizing the world of online retail for a smarter and more enjoyable shopping experience." />
