...
const index = () => {
  return (
    <>
        ...
        <title>
          Innovate Manufacturing Excellence with Giri InfoTech Solutions
        </title>

        <meta
          name="description"
          content="Explore the future of manufacturing with Giri InfoTech's advanced technology solutions. From smart production systems to efficient supply chain management, our technology reshapes the manufacturing landscape. Discover how Giri InfoTech is driving innovation, efficiency, and sustainability in the manufacturing sector." />
