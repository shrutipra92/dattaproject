...
const index = () => {
  return (
    <>
        ...
        <title>
          Unlock Unforgettable Journeys with Giri InfoTech  | Travel and Hospitality Solutions
        </title>

        <meta
          name="description"
          content="Embark on a journey like never before with Giri InfoTech's innovative travel and hospitality solutions. From seamless booking experiences to smart hotel management, discover how Giri InfoTech is redefining the travel and hospitality industry. Explore our technology for a world of memorable and personalized experiences." />
