...
const index = () => {
  return (
    <>
        ...
        <title>
          Revolutionizing Telecommunications | Giri InfoTech  Solutions
        </title>

        <meta
          name="description"
          content="Discover the future of telecommunications with Giri InfoTech. Our innovative solutions redefine connectivity, enhance communication networks, and advance telecom technology. Explore how Giri InfoTech is leading the way in shaping a connected and communicative world." />
