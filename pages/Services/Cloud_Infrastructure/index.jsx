...
const index = () => {
  return (
    <>
        ...
        <title>
          Scalable Cloud Infrastructure Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Transform your business with Giri InfoTech's state-of-the-art cloud infrastructure solutions. From scalable computing power to secure storage, our technology empowers enterprises with the flexibility and reliability of cloud computing. Discover how Giri InfoTech  is redefining the future of IT infrastructure for a more agile and responsive business environment." />
