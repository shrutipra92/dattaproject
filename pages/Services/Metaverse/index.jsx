...
const index = () => {
  return (
    <>
        ...
        <title>
          Explore Boundless Realms: Metaverse Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Dive into the infinite possibilities of the metaverse with Giri InfoTech's innovative solutions. Our technology transforms digital experiences, creating immersive, interconnected virtual worlds. Discover how Giri InfoTech  is shaping the future of the metaverse, unlocking new dimensions for collaboration, entertainment, and exploration." />
