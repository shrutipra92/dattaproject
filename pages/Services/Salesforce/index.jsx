...
const index = () => {
  return (
    <>
        ...
        <title>
          Unlock Business Potential with Salesforce Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Elevate your customer experience and streamline business processes with Giri InfoTech's Salesforce solutions. Our technology expertise leverages the power of Salesforce, delivering seamless CRM, automation, and innovation. Explore how Giri InfoTech  is transforming businesses through Salesforce for enhanced efficiency and customer satisfaction." />
