...
const index = () => {
  return (
    <>
        ...
        <title>
          Immersive Experiences Redefined: AR/VR Solutions by Giri InfoTech 
        </title>

        <meta
          name="description"
          content="Dive into the future of immersive technologies with Giri InfoTech's AR/VR solutions. From augmented reality applications to virtual reality experiences, our technology creates engaging and transformative interactions. Explore how Giri InfoTech  is at the forefront of shaping the digital landscape with innovative AR/VR solutions." />
