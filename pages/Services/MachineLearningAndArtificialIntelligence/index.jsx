...
const index = () => {
  return (
    <>
        ...
        <title>
          Unleashing Intelligence: AI and ML Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Step into the future with Giri InfoTech's AI and ML solutions, where innovation meets intelligence. Our technology harnesses the power of artificial intelligence and machine learning, redefining possibilities for businesses. Explore how Giri InfoTech  is driving transformative insights, automation, and intelligent decision-making." />
