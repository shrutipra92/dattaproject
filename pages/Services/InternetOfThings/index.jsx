...
const index = () => {
  return (
    <>
        ...
        <title>
          Empowering Connectivity: IoT Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Step into the era of seamless connectivity with Giri InfoTech's innovative Internet of Things (IoT) solutions. Our technology transforms industries, enhances efficiency, and brings intelligence to devices. Explore how Giri InfoTech  is at the forefront of shaping a connected and smarter world through IoT innovations." />
