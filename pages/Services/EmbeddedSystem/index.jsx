...
const index = () => {
  return (
    <>
        ...
        <title>
          Empowering Devices: Embedded Systems Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Explore the world of efficient and intelligent devices with Giri InfoTech's embedded systems solutions. Our technology seamlessly integrates smart systems into diverse applications, enhancing functionality and performance. Discover how Giri InfoTech  is driving innovation in embedded systems for a connected and intelligent future." />
