...
const index = () => {
  return (
    <>
        ...
        <title>
          Streamline Development to Operations: DevOps Solutions by Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Empower your development and operations workflows with Giri InfoTech 's cutting-edge DevOps solutions. Our technology bridges the gap between development and IT operations, fostering collaboration, automation, and efficiency. Explore how Giri InfoTech  is leading the way in reshaping software delivery pipelines for a faster and more reliable development process." />
