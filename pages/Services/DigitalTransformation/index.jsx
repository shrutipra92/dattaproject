...
const index = () => {
  return (
    <>
        ...
        <title>
          Embrace Digital Transformation with Giri InfoTech  Solutions
        </title>

        <meta
          name="description"
          content="Unlock the full potential of your organization through digital transformation with Giri InfoTech . Our technology solutions empower businesses to innovate, optimize processes, and stay ahead in the digital era. Explore how Giri InfoTech  is reshaping industries through comprehensive and strategic digital transformation initiatives." />
