...
const index = () => {
  return (
    <>
        ...
        <title>
          Seamless Mobility Solutions for a Connected World | Giri InfoTech  
        </title>

        <meta
          name="description"
          content="Explore the next wave of mobility with Giri InfoTech's cutting-edge technology solutions. From smart transportation to connected vehicles, our mobility solutions redefine the way we move. Discover how Giri InfoTech  is driving innovation in transportation, enhancing connectivity, and shaping a smarter, more efficient world." />
