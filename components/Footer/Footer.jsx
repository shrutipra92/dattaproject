        ...
        <footer className='w-full text-white'>
            ...
            <div className='w-full 1000px:justify-around pt-[20px] bg-[#005482] px-[10px] gap-[5px] 900px:gap-0 hidden 500px:flex'>
                ...
                <div className='flex flex-col gap-[10px] flex-1 text-[12px] 900px:text-[18px]'>
                    ...
                    <p className='900px:text-[20px] text-[16px] font-[600] text-gray-400 cursor-pointer'>Why Giri InfoTech?</p>
                ...
                <div className='flex flex-col gap-[10px] flex-1 text-[12px] 900px:text-[18px]'>
                    ...
                    <p className='text-[16px] font-[400] hover:underline'>+91 98103 53379</p>
                    <p className='text-[16px] font-[400] hover:underline'>Giri InfoTech Pvt Ltd</p>
                    <p className='text-[16px] font-[400] hover:underline'>D- 40, sector 6 Noida, GB Nagar, U.P., India, 201301</p>
            ...
            <div className='w-full h-[100px] bg-black flex items-center justify-center 1000px:gap-[80px] gap-[30px]'>
                ...
                <div className='1000px:font-[700] font-[600] 1000px:text-[26px] text-[20px] cursor-pointer hidden 500px:block'>Giri InfoTech Pvt. Ltd.</div>
