            ...
            <div className='w-full py-[30px] bg-blueBackground flex items-center justify-center'>
                ...
                <div
                    ...
                    <p className='text-[20px] 700px:text-[26px] 900px:text-[32px] font-[600] my-[10px]'>
                        By choosing Giri InfoTech  as your Salesforce (MuleSoft) partner, you gain access to a dedicated team of experts committed to helping your business thrive in the digital age. We look forward to the opportunity to work with you and contribute to your organization's growth and success.
                    </p>
