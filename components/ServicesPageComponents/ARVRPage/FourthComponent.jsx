...
const FourthComponent = () => {
    ...
    return (
        <div className='w-[90%] 1000px:w-[80%] mx-auto py-[40px] flex flex-col items-center justify-center gap-[16px]'>
            ...
            Giri InfoTech  proudly showcases a track record of award-winning and groundbreaking achievements. As true pioneers in the fields of Augmented Reality (AR), Virtual Reality (VR), Game Development, and Animations, we invite you to explore the forefront of innovation with our exceptional portfolio.
            </p>
