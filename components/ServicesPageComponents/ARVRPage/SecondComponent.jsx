  ...
  return (
    <div className='w-[90%] 1000px:w-[80%] mx-auto py-[50px] flex flex-col 1000px:flex-row'>
        ...
        <div className='w-full 1000px:w-[50%] flex flex-col justify-center gap-[30px]'>
            ...
            About Giri InfoTech  - AR/VR Excellence, Delivered
            </p>

            <p className='text-[20px] leading-[22px]'>
            Giri InfoTech  has the necessary expertise in AR/VR development, including knowledge of platforms like Unity or Unreal Engine, 3D modeling, and experience with AR/VR hardware such as Oculus Rift, HTC Vive, or ARKit/ARCore for mobile devices
            </p>
