            ...
            className='w-full h-[95vh] 1000px:h-[90vh] relative flex items-end pb-[20px] 1000px:pb-0 1000px:items-center overflow-hidden bg-black'>
                ...
                <motion.div
                    ...
                    <p className='text-white text-[20px] w-full 700px:w-[520px] leading-[24px]'>
                        Augmented Reality (AR) and Virtual Reality (VR) technologies have been gaining significant traction in various industries, including gaming, healthcare, education, real estate, Aviation and more. Giri InfoTech  is specialising in AR/VR applications development and services.
                    </p>
