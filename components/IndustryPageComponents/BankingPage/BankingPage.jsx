...
<p className='text-white font-[700] text-[28px] 700px:text-[32px] leading-[38px] 700px:leading-[36px]'>
                <span>Giri InfoTech  In The Banking Industry</span>
                </p>

                <div className='text-white text-[20px] w-full 700px:w-[520px] leading-[24px] flex flex-col gap-[6px]'>
               
                <span>
                The banking industry has undergone a significant transformation in recent years, driven by technological advancements and changing customer preferences. To thrive in this dynamic environment Giri InfoTech  play a crucial role in supporting banks and financial institutions.
                </span>
                </div>
