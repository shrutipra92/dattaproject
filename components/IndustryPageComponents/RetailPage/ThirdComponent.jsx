...
const ThirdComponent = () => {
    ...
    const contentArray = [
        ...
        {
            heading: "Our Mission",
            para: "At Giri InfoTech , our mission is to revolutionize the retail landscape through innovative IT solutions. We are committed to empowering retail businesses of all sizes, from local boutiques to global brands, with the technology they need to thrive in an ever-evolving digital world. Our mission is to be the trusted partner that retailers turn to for tailored, cutting-edge IT solutions that drive growth, enhance customer experiences, and ensure lasting success.",
