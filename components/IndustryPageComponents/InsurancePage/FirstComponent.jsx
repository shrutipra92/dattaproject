    ...
    return (
        <div
            ...
            <p className='text-[26px] w-[90%] 1000px:w-[80%] mx-auto'>
                In an era where digital transformation is reshaping industries, the insurance sector is no exception. At Giri InfoTech , we understand the unique challenges faced by insurance companies and offer tailored IT solutions to streamline operations, mitigate risks, and elevate customer satisfaction.
            </p>
