    ...
    <div className='w-full h-[60vh] relative flex items-center justify-center flex-col gap-[12px]'>
     <img
          ...
          <motion.div
              ...
              Business Transformation Success Story for Airport
          </motion.div>
          </div>
        ...
        <div className='relative mb-[8px] w-[250px] h-[300px]'>
              ...
              <div className='bg-white w-[150px] h-fit absolute top-[50px] px-2'>
                Working with Giri InfoTech  was a game-changer for our engineering team. Our Engineering team now perform all kind of trainings at finger tips.
                </div>
          </div>
          ...
          <div className='relative mb-[20px] w-[250px] h-[40vh]'>
              ...
              <div className='bg-white w-[150px] h-fit absolute top-[50px] px-2'>
              Giri InfoTech  solutions not only resolved our challenges but also opened new growth opportunities. We streamlined processes, eliminated bottlenecks, andachieved remarkable efficiency gains.
              </div>
          </div>
          ...
          <div className='relative mb-[8px] w-[250px] h-[300px] mt-40'>
              ...
              <div className='bg-white w-[150px] h-fit absolute top-[50px] px-2'>
              With Giri InfoTech , we now have real-time insights into our equipment health, predictive maintenance capabilities, and streamlined work order management.
