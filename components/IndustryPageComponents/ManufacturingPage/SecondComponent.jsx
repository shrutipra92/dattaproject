...
const SecondComponent = () => {
    ...
    const componentArray = [
        ...
        },
        {
            ...
            para: "Giri InfoTech  has a proven track record of successfully implementing IT solutions in manufacturing environments. Our satisfied clients testify to the positive impact of our services on their operations.",
