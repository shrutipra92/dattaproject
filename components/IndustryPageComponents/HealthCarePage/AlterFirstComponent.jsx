    ...
    return (
        <div
            ...
            <p className='text-[26px] w-[90%] 1000px:w-[80%] mx-auto'>
                In the dynamic landscape of healthcare, staying ahead requires not just expertise but innovation. At Giri InfoTech  we specialize in delivering top-notch Healthcare IT services that streamline operations, enhance patient care, and elevate your organization to new heights.
            </p>
