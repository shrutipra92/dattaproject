    ...
    return (
        <div
            ...
            <p className='text-[26px] w-[90%] 1000px:w-[80%] mx-auto'>
                In the dynamic landscape of the Energy and Utilities industries, leveraging cutting-edge technology is imperative for staying competitive, efficient, and sustainable. At Giri InfoTech , we specialize in delivering innovative IT solutions designed to empower your business in the energy and utilities sectors.
            </p>
